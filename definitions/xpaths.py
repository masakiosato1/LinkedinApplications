...
page_xpath = "/html/body/div[contains(@class, 'application-outlet')]/div[3]/div[4]/div/div/main/div/div[1]/div/div[contains(@class, 'jobs-search-results-list__pagination')]/ul/li"